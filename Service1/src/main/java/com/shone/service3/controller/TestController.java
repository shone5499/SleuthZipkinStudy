...
import com.shone.service3.service.ServiceTwoFeignService;
...
public class TestController {
    ...
    private String pre = "Service1 Controller from ";
    ...
    @GetMapping("/get3")
    public String get3(){
        System.out.println("Service1 Controller 调用Service2 调用Service3");
        return pre + serviceTwoFeignService.getFromClientThree();
    }

    @GetMapping("/get4")
    public String get4(){
        System.out.println("Service1 Controller 调用Service2 调用Service4");
